...
\begin{figure}[htb!]
    ...
    \begin{minipage}{0.4\textwidth}
        \centering
        \includegraphics[width=\linewidth]{outputs/week3/1d_power_spectrum_0_0.1.pdf}
    ...
    \begin{minipage}{0.4\textwidth}
        \centering
        \includegraphics[width=\linewidth]{outputs/week3/1d_log_power_spectrum_0_0.1.pdf}
...
https://www.overleaf.com/project\begin{figure}[htb!]
    \centering
    % Log Plot
    \begin{minipage}{0.4\textwidth}
        \centering
